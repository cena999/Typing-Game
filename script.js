...
//choose word from array
    function random() {
        words.innerHTML = "";
        var random = Math.floor(Math.random() * 1950);
  ...
  'EARN','EARTH','EASIER','EASILY','EAST','EASTER','EASY','EAT','EATEN',
  'EDGE','EDUCATION','EFFECT','EFFORT','EGG','EIGHT','EITHER','ELECTRIC',
  'ELECTRICITY','ELEMENT','ELEMENTAL','ELEPHANT','ELEVEN','ELSE','EMPTY','END','ENEMY',
  ...
  'FAILED','FAIR','FAIRLY','FALL','FALLEN','FAMILIAR','FAMILY','FAMOUS','FANTASY',
  'FAR','FARM','FARMER','FARTHER','FAST','FASTENED','FASTER','FAT',
  'FATHER','FAVORITE','FEAR','FEATHERS','FEATURE','FED','FEED','FEEL',
  'FEET','FELL','FELLOW','FELT','FENCE','FEW','FEWER','FIELD',
  'FIERCE','FIFTEEN','FIFTH','FIFTY','FIGHT','FIGHTER','FIGHTING','FIGURE','FILL',
